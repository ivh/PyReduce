...
instrument.info["wavelength_range"] =   [[
    ...
    [4024, 4118],  # Order 84
#    [3977, 4069],  # Order 85
][::-1]] # ATTN, flipping the order to match the order of the traces
...
files = { "bias": ["Bias_0s_20240621_221716-%d.fit"%i for i in np.arange(1,11)],
     ...
     "wavecal_master":["Sun_Calibration_35s_20240621_184136-%d.fit"%i for i in np.arange(1,2)],
